...
app.use(cors({
    origin: [
        'https://qlkhtt-kltn-96-git-main-qlkhtt.vercel.app',
        'http://localhost:3000',
        'https://qlkhtt-kltn-96-pied.vercel.app' // Địa chỉ localhost bạn sử dụng
      ], // Cho phép frontend
...
const io = require("socket.io")(8080, {
    cors: {
      origin: "https://qlkhtt-kltn-96-git-main-qlkhtt.vercel.app", // Địa chỉ front-end
